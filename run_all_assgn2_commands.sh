...
#Neuronet Branch Prediction 
echo "Building bin file for Neuronet Branch predictor"
./build_champsim.sh neuronet no no no no lru 1
echo "Built bin file for bimodal perceptron no no no no lru 1"
echo "================================================================="
echo "Running SPEC Traces for bimodal Perceptron Branch Prediction"
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 400.perlbench-41B.champsimtrace.xz
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 401.bzip2-277B.champsimtrace.xz
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 403.gcc-16B.champsimtrace.xz
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 410.bwaves-945B.champsimtrace.xz
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 416.gamess-875B.champsimtrace.xz
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 454.calculix-104B.champsimtrace.xz
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 462.libquantum-1343B.champsimtrace.xz
echo "Running PARSEC Traces for Bimodal Branch Prediction"
echo "================================================================="
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 parsec_2.1.blackscholes.simlarge.prebuilt.drop_4000M.length_216M.champsimtrace.xz
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 parsec_2.1.bodytrack.simlarge.prebuilt.drop_2000M.length_250M.champsimtrace.xz
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 parsec_2.1.canneal.simlarge.prebuilt.drop_5000M.length_15M.champsimtrace.xz
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 parsec_2.1.dedup.simlarge.prebuilt.drop_29000M.length_250M.champsimtrace.xz
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 parsec_2.1.raytrace.simlarge.prebuilt.drop_23750M.length_250M.champsimtrace.xz
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 parsec_2.1.streamcluster.simlarge.prebuilt.drop_6250M.length_250M.champsimtrace.xz
./run_champsim.sh neuronet-no-no-no-no-lru-1core 1 10 parsec_2.1.swaptions.simlarge.prebuilt.drop_15000M.length_93M.champsimtrace.xz
echo "Done"
echo "================================================================="
